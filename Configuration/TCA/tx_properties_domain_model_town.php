...
return array(
	...
	'columns' => array(
		...
		'disable_filter_option' => array(
			'exclude' => FALSE,
			'label' => 'LLL:EXT:properties/Resources/Private/Language/locallang_db.xlf:tx_properties_domain_model_town.disable_filter_option',
			'config' => array(
				'type' => 'check',
				'items' => array(
					1 => array(
						0 => 'LLL:EXT:properties/Resources/Private/Language/locallang_db.xlf:tx_properties_domain_model_town.disable_filter_option.0',
					),
				),
			),
		),
